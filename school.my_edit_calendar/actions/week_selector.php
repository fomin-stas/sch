...
$my_edit_calendar_work_path = '/bitrix/components/school/school.my_edit_calendar';
//$my_edit_calendar_work_path=substr(dirname($tmp_str), strrpos($tmp_str, '/bitrix/'));
//$my_edit_calendar_work_path=substr($my_edit_calendar_work_path,0,-8);
require_once($_SERVER["DOCUMENT_ROOT"].$my_edit_calendar_work_path.'/forms/lang/'.LANGUAGE_ID.'/copy_week.php');
